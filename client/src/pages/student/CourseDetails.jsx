...
const CourseDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-cyan-100 to-white">
      <div className="pt-20 pb-20 pl-8 md:pl-6 lg:pl-40 pr-8 md:pr-32 flex flex-col lg:flex-row gap-10">
        ...
        <div className="max-w-xl z-10 text00gray-500">
          ...
          <p
            className="pt-5 md:text-base text-sm"
        ...
        {/* right column */}
        <div className="max-w-course-card w-full h-fit bg-white lg:w-[580px] z-10 shadow-custom-card rounded-md md:rounded-none overflow-hidden lg:ml-20">
          {
            playerData ? 
